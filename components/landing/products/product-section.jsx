...
import { ImageCard } from "@/components/custom/ui/image-card";
  ...
  return (
    <Section className={cn("py-16 bg-background")}>
      <div className="container-width">
        {/* Stats Section */}
        <PatternBackground className="p-8 mb-16" backgroundColor="bg-blue-700">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          ...
          <ImageCard
            ...
            subtitle="Specialized Toe Socks"
          />
        </div>
